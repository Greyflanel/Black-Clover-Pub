let mqls = [window.matchMedia("(min-width: 300px)"), window.matchMedia("(min-width: 380px)"), window.matchMedia("(min-width: 650px)"), window.matchMedia("(min-width: 800px)"), window.matchMedia("(min-width: 850px)"), window.matchMedia("(min-width: 1000px)"), window.matchMedia("(min-width: 12810px)")];
...
function mediaqueryresponse(mql) {
  ...
  let tlMediaQueryNav = gsap.timeline({
    repeat: 0
  });
  let tlMediaQuery = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryText = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryClovers = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryClover1 = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryClover2 = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryClover3 = gsap.timeline({
    repeat: 0
  });
  let tlMediaQueryClover4 = gsap.timeline({
    repeat: 0
  }); // Sets Initial Values

  tlContent.set("#clovers", {
    display: "inline"
  });
  tlLogo.set(".logo", {
    display: "inline",
